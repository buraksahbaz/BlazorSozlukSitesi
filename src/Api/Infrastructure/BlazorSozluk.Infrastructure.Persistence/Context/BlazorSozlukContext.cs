...
namespace BlazorSozluk.Infrastructure.Persistence.Context
{
    public class BlazorSozlukContext: DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                string connStr = "Data Source=DESKTOP-9U9OQIS\\SQLEXPRESS;Initial Catalog=blazorsozluk;Persist Security Info=True;TrustServerCertificate=True;User ID=sa;Password=1"; 
